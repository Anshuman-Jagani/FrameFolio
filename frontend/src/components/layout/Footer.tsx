...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-parchment-200 bg-parchment-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="flex flex-col md:flex-row gap-8 md:items-center md:justify-between">
          <div className="flex flex-col">
            ...
            <p className="text-sm text-olive-500 max-w-md mt-1">
          ...
          <div className="flex gap-6">
            <Link
              to="/photographers"
              className="text-sm text-olive-500 hover:text-charcoal-700 transition-colors"
            >
        ...
        <div className="mt-8 text-xs text-copper-500">
