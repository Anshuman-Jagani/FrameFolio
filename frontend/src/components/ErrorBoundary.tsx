    ...
    if (this.state.hasError) {
      return (
        <div className="max-w-lg mx-auto px-4 py-16 text-center">
          <div className="rounded-3xl border border-taupe-100 bg-cream-100 p-8 shadow-sm">
            ...
            <Link
              to="/"
              className="mt-6 inline-flex rounded-2xl bg-burgundy-500 text-cream-50 px-5 py-3 text-sm font-medium hover:bg-burgundy-600 transition-colors"
            >
              Back home
            </Link>
          </div>
